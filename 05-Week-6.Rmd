...
[Download the data file here](files/location_music_Wk6.csv)

1. Download the data file "location_music_Wk6.csv", "Week_6_lab.R" and "Week_6_binomial.R" files from the Week 6 lab resources folder on Moodle.
...
![sign test table](files/sign_test_table.png)
