...
The materials should be reasonably self-contained, though there are references to lecture content at times. Some of the lab content involves the use of "learnr tutorials". These are online, interactive tutorials, that run in a browser. You should be able to access these by clicking on the relevants links. 