...
If you feel it may be useful, **you can work through Task 1 before the lab class**. In preparation for Task 2, please do the following things:
...
To access the tutorial click here: https://psylancs.shinyapps.io/Week_9_learnr/ (not available until Monday morning)
...
2. Run the first two lines of code `library(tidyverse)` and `data <- read_csv("gamble_salary.csv")`
